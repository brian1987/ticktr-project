...
class PreferencesControllerTest < ActionController::TestCase
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post :create, preference: { baseball: @preference.baseball, concert: @preference.concert, email: @preference.email, sports: @preference.sports }
    end
  ...
  test "should update preference" do
    patch :update, id: @preference, preference: { baseball: @preference.baseball, concert: @preference.concert, email: @preference.email, sports: @preference.sports }
    assert_redirected_to preference_path(assigns(:preference))
  end
